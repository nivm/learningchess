...
def find_surround(location, board_array):
	x,y = location[0], location[1]
	surround = []
	try:
		surround.append(board_array[x-1][y-1])
	except:
		surround.append("z")
	try:
		surround.append(board_array[x][y-1])
	except:
		surround.append("z")
	try:
		surround.append(board_array[x+1][y-1])
	...
	try:
		surround.append(board_array[x-1][y])
	except:
		surround.append("z")
	surround.append("o")
	try:
	...
	surround = [transalte_surround(s) for s in surround]
	return surround

def transalte_surround(s):
	if s ==1:
		return "y"
	if s == "z" or s=="o":
		return s
